...
| **Key Resources** | Open-source codebase (Apache 2.0); brand and documentation assets; trained agent network; documented maintainer and community governance capacity; Celo blockchain infrastructure |
...
flowchart TD
    ...
    CeloHT --> Governance[Community Governance / Maintainers / Community Contributors]
...
| Maintainers and contributors | Sustainable, well-governed organization | Diversified funding reducing single-point dependency |
...
4. **Governance scaling:** As activity grows, CeloHT SHOULD expand community governance capacity deliberately (see `GOVERNANCE.md`) to avoid concentration of decision-making even as the organization grows.
...
| Key-person dependency (core contributors / founder role) | Medium | High | Community governance structure; documented processes; succession planning in `GOVERNANCE.md` |
...
4. CeloHT SHOULD maintain a prudent operating reserve (target to be set by the documented governance process once Phase 2 financial data exists) sufficient to sustain core mission activities through short-term funding gaps.
...
flowchart TD
    ...
    M --> BizReview[Business Model & Revenue Proposal Review]
...
1. Any new revenue stream or material pricing change MUST be reviewed through the documented community governance process before launch.
2. No single individual MUST unilaterally approve new commercial offerings; approval follows the same community-governance logic as partnerships (see `PARTNERSHIPS.md` Section 22).
...
- [`GOVERNANCE.md`](./GOVERNANCE.md) — community-governed structure with contributors, maintainers, and the Governance Council
