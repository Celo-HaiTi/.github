...
CeloHT's GitHub presence (historically hosted under the legacy Celo-HT
organization) hosted its public repositories, issue trackers, and discussion
forums, consistent with the Open Source Collaboration principle in
`GOVERNANCE.md` Section 2.4. Current repositories use `Celo-HaiTi`.
