...
**Version:** 1.0.0
**Effective Date:** 2026
**Maintained By:** CeloHT maintainers and the documented community governance process
...
- Establish RFC 2119-grade obligations so that governance decisions remain consistent and reviewable over time, independent of who currently holds a given role.

This policy applies to all CeloHT repositories, all official CeloHT communication channels (celoht.com, @CeloHT / celohtofficial on Facebook and Instagram, contact@celoht.com), and all individuals acting in an official capacity on behalf of CeloHT, including maintainers, governance participants, and community contributors.
...
3. **Community governance first.** No single individual MAY unilaterally bind CeloHT to a partnership. All partnerships flow through the [Approval Process](#22-approval-process).
...
4. Any Governance Council member or designated review participant who becomes aware of suspected corruption involving a CeloHT partnership MUST report it under the process described in [Section 14](#14-conflict-of-interest-policy) and, where applicable, to the documented governance authority for the matter.
...
1. A conflict of interest exists whenever a Governance Council member, designated review participant, or Community Contributor involved in a partnership decision has a financial, familial, or other personal interest in the outcome.
...
5. Failure to disclose a known conflict of interest is a governance violation and MAY result in removal from the relevant review or decision body, per [GOVERNANCE.md](./GOVERNANCE.md).
...
CeloHT partnerships are governed within the organization's existing governance structure:

```mermaid
flowchart TD
    G[Community Governance] --> M[Maintainers]
    M --> CC[Community Contributors]
    M --> PL[Partnerships Lead]
    PL --> DD[Due Diligence Reviewers]
    PL --> REG[Public Partnership Registry Maintainer]
```

- No single individual has unilateral authority to approve partnerships.
- Maintainers and the relevant governance bodies review due diligence, risk, and approval decisions under the documented process.
...
|---|---|---|
| **Maintainers** | Review due diligence and risk assessments; participate in approvals, suspensions, and terminations; maintain this policy | Collective approval under the governance process |
| **Partnerships Lead** | Coordinates inquiries, due diligence, and drafting of agreements; maintains the Public Partnership Registry | Recommends, does not unilaterally approve |
...
| Ecosystem Participant | Partnerships Lead + one maintainer reviewer |
| Strategic Collaborator | Majority approval under the documented governance process |
| Confirmed Partner | Approval under the documented governance process, with written agreement execution and registry update |
...
flowchart TD
    ...
    B --> C[Circulate for documented review - minimum 5 business days]
    C --> D[Conflict of Interest Disclosures Collected]
    D --> E[Approval under the documented governance process]
    E --> F{Approved?}
    F -- No --> G[Declined - Reasons Logged]
    F -- Yes --> H[Written understanding or agreement finalized]
    H --> K[Registry Updated]
```
...
3. No partnership funds MAY be commingled with undisclosed personal accounts of any Governance Council member, designated review participant, or Community Contributor.
...
4. Governance Council members or designated reviewers with access to confidential information remain bound by the [Conflict of Interest Policy](#14-conflict-of-interest-policy) and MUST NOT use confidential partner information for personal benefit.

---

## 31. Monitoring and Evaluation

1. Every Strategic Collaborator and Confirmed Partner relationship MUST have a designated Governance Council monitor or designated review lead responsible for tracking progress against agreed objectives.
...
2. Unilateral termination by CeloHT requires a two-thirds (2/3) Governance Council vote, except in cases of confirmed fraud, corruption, or legal violation, where a designated governance authority MAY act immediately only under the documented emergency procedure and subject to Council ratification within 10 business days.
...
## 11. Signatures
CeloHT Authorized Signatory: ______________  Date: ______
...
- [`GOVERNANCE.md`](./GOVERNANCE.md) — community governance, maintainers, and contributor structure
