...
CeloHT's GitHub presence hosts its public repositories, issue trackers, and
discussion forums under the official `Celo-HaiTi` organization, consistent
with the Open Source Collaboration principle in `GOVERNANCE.md` Section 2.4.
